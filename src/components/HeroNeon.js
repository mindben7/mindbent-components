...
export default function HeroNeon(props) {
    ...
    return (_jsxs("div", { style: containerStyle, children: [_jsx("div", { style: playerWrapperStyle, children: _jsx(ReactPlayer, { url: vimeoUrl, playing: true, loop: true, muted: true, controls: false, width: "100%", height: "100%", style: { position: 'absolute', top: 0, left: 0 }, config: {
                        vimeo: {
                            playerOptions: {
                                background: 1,
                                loop: 1,
                    ...
                    } }) }), showTitle && (_jsx("div", { style: contentStyle, children: _jsx("h1", { style: titleStyle, children: title }) }))] }));
}
